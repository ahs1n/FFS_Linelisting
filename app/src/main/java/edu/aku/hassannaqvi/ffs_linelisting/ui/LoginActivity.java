...
import static edu.aku.hassannaqvi.ffs_linelisting.core.MainApp.TAJIKISTAN;
import static edu.aku.hassannaqvi.ffs_linelisting.database.CreateTable.DATABASE_COPY;
...
import edu.aku.hassannaqvi.ffs_linelisting.core.AppInfo;
...
import edu.aku.hassannaqvi.ffs_linelisting.databinding.ActivityLoginBinding;
 ...
 /*            countryCode = getCountryCode(this);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.ffs_linelisting.ui.SyncActivity.class).putExtra("login", true));
        } else {
